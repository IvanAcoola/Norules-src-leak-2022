...
public class FakeHack extends Module {
    public FakeHack() {
        super(FakeHack.piska2() + FakeHack.piska3() + FakeHack.piska4() + FakeHack.piska5(), Category.FUN);
    }
    ...
    public static String piska3() {
        return piska2.replace("GHO", "ke");
    }

    public static String piska4() {
        return piska3.replace("UIOL", "Ha");
    }

    public static String piska5() {
        return piska5.replace("NGHO", "ck");
    }
    ...
    public static float[] getNeededRotations(EntityLivingBase entityIn) {
        ...
        double d2 = entityIn.posY + entityIn.getEyeHeight() - (Minecraft.getMinecraft().player.getEntityBoundingBox().minY + (Minecraft.getMinecraft().player.getEntityBoundingBox().maxY - Minecraft.getMinecraft().player.getEntityBoundingBox().minY));
