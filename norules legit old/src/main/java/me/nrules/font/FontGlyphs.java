...
public class FontGlyphs {
	...
	public final void destroy() {
		...
		while (var2.hasNext()) {
			FontGlyphs.GlyphChunk chunk = (FontGlyphs.GlyphChunk) var2.next();
	...
	private final FontGlyphs.GlyphChunk loadGlyphChunk(int chunk) {
		...
		try {
			...
			int var30 = MathUtilsNR.ceilToPOT(positionY + rowHeight);
			short var32 = 1024;
			boolean var12 = false;
	...
	public static final class GlyphChunk {
		...
		public boolean equals(@Nullable Object other) {
			if ((FontGlyphs.GlyphChunk) this == other) {
				...
				FontGlyphs.CharInfo[] var2 = this.charInfoArray;
