...
public class Slider extends Component {
	...
	public void renderComponent() {
		//настройки регулировки скорости и прочей хуйни
		/*double kak = ((setting.getValDouble()) - setting.getMin()) / (setting.getMax() - setting.getMin());
		currentValueAnimate = AnimationUtil.animation1(currentValueAnimate, (float) kak, 0.125f, 0.000000001f);*/
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, (int) (parent.parent.getX() + parent.parent.getWidth()), parent.parent.getY() + offset + 12, this.hovered ? 0xFF222222 : 0xFF111111);
		final int drag = (int)(this.set.getValDouble() / this.set.getMax() * this.parent.parent.getWidth());
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12, hovered ? 0xFF555555 : 0xFF444444);
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + 2, parent.parent.getY() + offset + 12, 0xFF111111);
		GL11.glPushMatrix();
		Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.set.getName() + ": " + this.set.getValDouble() , (parent.parent.getX() + 4), (parent.parent.getY() + offset + 2), Color.LIGHT_GRAY.brighter().brighter().getRGB());
